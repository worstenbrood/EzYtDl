...
namespace SoundTouch
{
    public sealed class SoundTouchProcessor : IDisposable
    {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="SoundTouchProcessor"/> class.
        /// </summary>
        ~SoundTouchProcessor()
        {
    ...
    public sealed class BpmDetect : IDisposable
    {
        ...
        private static class NativeMethods
        {
            ...
            [DllImport(SoundTouchProcessor.SoundTouchLibrary, CallingConvention = CallingConvention.Cdecl, EntryPoint = "bpm_destroyInstance")]
            public static extern void BpmDestroyInstance(IntPtr h);

            [DllImport(SoundTouchProcessor.SoundTouchLibrary, CallingConvention = CallingConvention.Cdecl, EntryPoint = "bpm_putSamples")]
            public static extern void BpmPutSamples(IntPtr h, float[] samples, uint numSamples);

            [DllImport(SoundTouchProcessor.SoundTouchLibrary, CallingConvention = CallingConvention.Cdecl, EntryPoint = "bpm_putSamples_i16")]
            public static extern void BpmPutSamples_i16(IntPtr h, short[] samples, uint numSamples);

            [DllImport(SoundTouchProcessor.SoundTouchLibrary, CallingConvention = CallingConvention.Cdecl, EntryPoint = "bpm_getBpm")]
